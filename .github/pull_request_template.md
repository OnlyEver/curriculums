<!-- Keep this lean. The linked issue holds the spec; this PR holds the change. -->

## Summary
<!-- One or two lines: what changed and why. -->

Closes #<!-- issue number — REQUIRED. Closing keywords only fire when this PR targets the default branch. -->

## Verification
<!-- How you confirmed it works (the issue's verification step). -->
